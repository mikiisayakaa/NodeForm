...
#include "../../NodestCalculator/gsdefines.h"
...
struct qt_meta_stringdata_Nodest__DoubleSetter_t {
    QByteArrayData data[4];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Nodest__DoubleSetter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Nodest__DoubleSetter_t qt_meta_stringdata_Nodest__DoubleSetter = {
    {
QT_MOC_LITERAL(0, 0, 20), // "Nodest::DoubleSetter"
QT_MOC_LITERAL(1, 21, 12), // "receiveValue"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 5) // "value"

    },
    "Nodest::DoubleSetter\0receiveValue\0\0"
    "value"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Nodest__DoubleSetter[] = {
...
void Nodest::DoubleSetter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DoubleSetter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveValue((*reinterpret_cast< const double(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject Nodest::DoubleSetter::staticMetaObject = { {
    &AbstractSlotSetter::staticMetaObject,
    qt_meta_stringdata_Nodest__DoubleSetter.data,
    qt_meta_data_Nodest__DoubleSetter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *Nodest::DoubleSetter::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Nodest::DoubleSetter::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Nodest__DoubleSetter.stringdata0))
        return static_cast<void*>(this);
    return AbstractSlotSetter::qt_metacast(_clname);
}

int Nodest::DoubleSetter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AbstractSlotSetter::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
